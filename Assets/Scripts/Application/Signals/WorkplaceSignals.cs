...
namespace App.Signals
{
    public class WorkplaceSignals
    {
        ...
        public class RegisterWorkplace
        {
            ...
            public RegisterWorkplace(BuildingView buildingView)
            {
        ...
        public class UnregisterWorkplace
        {
            ...
            public UnregisterWorkplace(BuildingView buildingView)
            {
                BuildingView = buildingView;
            }
        }
        ...
        public class RegisterSupplyTarget
        {
            ...
            public RegisterSupplyTarget(BuildingView buildingView)
            {
                BuildingView = buildingView;
            }
        }
        ...
        public class UnregisterSupplyTarget
        {
            ...
            public UnregisterSupplyTarget(BuildingView buildingView)
            {
                BuildingView = buildingView;
            }
        }
